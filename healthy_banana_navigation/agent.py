...
class Agent:
    def __init__(self, state_size, action_size, seed, load_trained_model=False, model_state_path=None, train_mode=False, resume_train=True):
        assert resume_train == train_mode
